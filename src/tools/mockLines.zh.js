...
export const LINES_ZH = {
  flirt: [
    ['blush', -8, 16, '*她把视线移开，又移回来，嘴角出卖了她。* “你真是没救了。”'],
    ['shy', -5, 13, '*一声短促的、几乎算是笑的呼气。* “别闹。我十分钟后还要试装。”'],
  ],
  care: [
    ['neutral', -10, 6, '*她整个人静了一下，像是有什么落到了实处。* “……嗯。好。”'],
    ['shy', -12, 9, '“你其实不用注意到这些的。” *停了一下。* “谢谢。”'],
  ],
  casual: [
    ['neutral', -4, 3, '*她一边收拾一边答话，那意思是不介意你待在这儿。* “嗯。今天挺长的。”'],
    ['happy', -6, 5, '“你每次都这么说。” *语气里几乎有点纵容。*'],
  ],
  work: [
    ['neutral', -3, 2, '*她没等你开口就把流程表拉了过来。* “行。说到哪儿了。”'],
    ['neutral', -2, 1, '“那段再从头过一遍。” *她已经开始数拍子了。*'],
  ],
  deflect: [
...
export const PLAYER_LINES_ZH = {
  flirt: ['你挺得意的', '你再说一遍，慢点说', '你是故意的'],
  care: ['我不会走', '你刚才做得很好', '吃饭了吗'],
  casual: ['问问今天怎么样', '随便聊聊', '就这么待一会儿'],
  work: ['那，说正事吧', '再走一遍', '今天得定下来'],
